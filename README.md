...
|-------------------------------|-------------------------------------------------------|---------------------------------------------------------------------|
| Contrapositive and Contradiction for Automated Reasoning | Indirect Reasoning (IR) method that employs the logic of contrapositives and contradictions for factual reasoning and mathematic proof. | https://arxiv.org/pdf/2402.03667 |
